...
class ReflexionBaseline:
    ...
    def _plan_with_memory(self, task: str, memory: str) -> str:
        ...
        try:
            # chat.completions matches agent.py's Qwen2.5 client (provider=auto)
            # text_generation is no longer supported via HF Inference Providers
    ...
    def _reflect(self, task: str, trace_output: dict) -> str:
        ...
        try:
            ...
            return f"[FALLBACK reflection - Qwen unavailable: {e}]"
